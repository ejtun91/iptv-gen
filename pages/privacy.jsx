  ...
  return (
    <div className={styles.container}>
      <div className={styles.mainContainer}>
        ...
        <p>
          Your privacy is important to us. It is IPTV Generator&#39;s policy to
          ...
          across our website,{" "}
          <a href="https://iptvgenerate.com">https://iptvgenerate.com</a>, and
          other sites we own and operate.{" "}
        </p>
        <p>
          This policy is effective as of 8 March 2022 and was last updated on 8
          March 2022.{" "}
        </p>
        ...
        <p>
          IPTV Gen
          <br />
          https://iptvgenerate.com/contact{" "}
        </p>
      </div>
    </div>
  );
